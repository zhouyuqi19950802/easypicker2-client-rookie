...
import { Lock, Message, QuestionFilled, User } from '@element-plus/icons-vue'
import { rAccount, rEmail, rPassword, rVerCode } from '@/utils/regExp'
...
watch(siteConfig, () => {
  if (siteConfig.value.needBindEmail) {
...
function getCode() {
  ...
  PublicApi.getCode(email.value, 'register').then(() => {
    time.value = 120
    refreshCodeText()
  ...
  <div class="register">
    <login-panel>
      <div class="inputArea">
        ...
        <div class="tc">
          <el-checkbox v-model="bindEmail" :disabled="siteConfig.needBindEmail">
            绑定邮箱
          </el-checkbox>
          <el-tooltip
            effect="dark"
